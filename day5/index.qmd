...
- RStudioでの作成方法：
  ...
  - 今回は`r4ds`プロジェクトの中で`diamond-sizes.qmd`という名前で作成しましょう
...
- QuartoとRを使って書いて、docx（ワードファイル）として出力

- 最終回までに提出して、授業中に発表する

## レポートの注意点

- AIを使って自分のデータを解析する場合、その前に指導教官と相談すること

---

- 結果とデータをgitに入れないでください
  - データは一旦決まったら、これ以上変わらないため
  - 結果は再現可能な文書の意味がなくなるため

- .gitignoreファイルの例（自分で作成するか、AIに頼む）
